...
const AddSong = () => {
    ...
    return loading ? (
        ...
        <form onSubmit={onSubmitHandler} action="" className='flex flex-col items-start gap-5 text-gray-600'>
            ...
            <div className='dflex flex-col gap-2.5'>
                <p>Song name</p>
            ...
            <div className='flex flex-col gap-2'>
                <p>Album</p>
                <select onChange={(e)=>setAlbum(e.target.value)} defaultValue={album} className='bg-transparent outline-green-600 border-2 border-gray-400 p-2.5 w-[150px]' id="">
